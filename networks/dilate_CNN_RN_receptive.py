...
x_train_mat = mat73.loadmat(filename)['x_train_receptive_mat']
...
#save_weights_name = 'leaky_upper_triang_RN_model_receptive_weights_density_' + density + '.h5'
#RN_model.save_weights(save_weights_name)

# Save the model architecture
#save_arch_name = 'leaky_upper_triang_RN_model_receptive_arch_density_' + density + '.json'
#with open(save_arch_name,'w') as f:
    #f.write(RN_model.to_json())


# Save the training loss
#train_loss_receptive = history.history['loss']
#np.save('train_loss_leaky_dilate_CNN_RN_receptive',train_loss_receptive)
...
#np.save('actual_scores_receptive',y_test)

#np.save('predicted_scores_receptive_no_shuffle',y_test_pred)
#np.save('predicted_scores_receptive_s10',y_test_pred)
