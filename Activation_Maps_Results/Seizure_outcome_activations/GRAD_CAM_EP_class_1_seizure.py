...
## This is for EP connectome class 1 for seizure outcome - NO seizure
...
filter_indices = 1 # since class 1 of seizure outcome - NO seizure
...
# Save Guided CAM   
sio.savemat('guided_grad_cam_class_1_top_20_test_cases.mat', mdict={'guided_grad_cam_class_1_top_20': grad_cam_top})

# Save CAM
#sio.savemat('grad_cam_class_1_top_20_test_cases.mat', mdict={'grad_cam_class_1_top_20': grad_cam_top})
    
#filename = 'guided_grad_cam_class_1_top_20_test_cases.mat'
#grad_cam_test = sio.loadmat(filename)['guided_grad_cam_class_1_top_20']    
